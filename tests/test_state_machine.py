...
PROGRESS_ANALYSIS_DONE = 50
PROGRESS_GENERATING = 75
PROGRESS_INITIAL = 0

MOCK_HISTORY_ID = 42
MOCK_SAVE_ID = 10
MOCK_USER_STORY_LENGTH = 31
MOCK_TEST_CASES_COUNT = 2
...
class TestAnalysisState:
    ...
    def test_valid_analysis_flow(self):
        ...
        assert state.get_progress_percentage() == PROGRESS_COMPLETE
    ...
    def test_mark_as_saved(self):
        ...
        state.mark_as_saved(MOCK_HISTORY_ID)

        assert state.is_saved()
        assert state.saved_history_id == MOCK_HISTORY_ID
    ...
    def test_complete_reset(self):
        ...
        state.saved_history_id = MOCK_HISTORY_ID
    ...
    def test_to_dict_serialization(self):
        ...
        assert data["user_story_length"] == MOCK_USER_STORY_LENGTH
...
class TestAnalysisStageTransitions:
    ...
    def test_idempotent_operations(self):
        ...
        state.mark_as_saved(MOCK_SAVE_ID)
        state.mark_as_saved(MOCK_SAVE_ID)
        state.mark_as_saved(MOCK_SAVE_ID)

        assert state.saved_history_id == MOCK_SAVE_ID
...
class TestIntegrationFlows:
    ...
    def test_happy_path_complete_analysis(self):
        ...
        assert state.get_progress_percentage() == PROGRESS_ANALYSIS_DONE
        ...
        state.start_plan_generation()
        assert state.get_progress_percentage() == PROGRESS_GENERATING
        ...
        # Validações finais
        assert len(state.test_plan_df) == MOCK_TEST_CASES_COUNT

...
class GitHubIntegration:
    ...
    def get_file_content(
        self, repo_path: str, file_path: str, branch: Optional[str] = None
    ) -> str:
        """
    ...
    def get_repository_structure(
        self, repo_path: str, branch: Optional[str] = None, max_depth: int = 3
    ) -> Dict[str, Any]:
        """
        ...
        def _explore_directory(
            repo: Repository, path: str, depth: int
        ) -> Dict[str, Any]:
            if depth > max_depth:
                return {}
    ...
    def search_code(
        self, repo_path: str, query: str, language: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
